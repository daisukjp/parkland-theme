...
<div class="about-us-banner-image" >
    <h2 class="top-of-page-banner-text" >ABOUT <img src="/parkland-taichi/wp-content/themes/parkland-theme/images/banner-underline.png" alt="styled brush stroke"></h2>
</div>


<div class="ptc-video">
    <video width="1280" height="auto" controls loop autoplay muted>
      <source src="/parkland-taichi/wp-content/themes/parkland-theme/images/ptc-video.mp4" type="video/mp4">
    </video>
</div>

<div class="about-us-section"  id="about-us">
   
    <h1>Brief history of Parkland Tai Chi<img src="/parkland-taichi/wp-content/themes/parkland-theme/images/brushstroke.png" alt="styled brush stroke"></h1>
